-- Keep recommendations limited to currently available offers and candidates with a CV vector.
CREATE OR REPLACE FUNCTION public.match_job_offers_for_candidate(
  ...
  SELECT
    o.id, o.application_email, o.application_whatsapp, o.auto_share,
    o.company, o.company_logo, o.contract_type, o.cover_image, o.created_at,
    o.deadline::text, o.description, o.expires_at::text, o.external_link,
    o.featured_until, o.slug, o.status, o.tags, o.title, o.updated_at,
    o.views_count, o.salary, o.publish_at, o.og_image, o.meta_title,
    o.meta_description, o.cover_image AS cover_image_url, o.similarity * 100 AS score
  FROM offers o
