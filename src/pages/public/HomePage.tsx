          ...
          {postsLoading ? (
            ...
            homePosts.map((post, i) => (
              <Link key={post.id} to={`/blog/${post.slug}`} className="group">
                <article className="rounded-3xl border border-border bg-card p-6 shadow-soft hover:shadow-elev transition-all fade-up group-hover:border-brand" style={{ animationDelay: `${i * 120}ms` }}>
