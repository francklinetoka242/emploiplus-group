                  ...
                  <div className="flex gap-4 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                    {featuredPosts.map((post) => {
                      ...
                      return (
                        <article
                          key={post.id}
                          className="flex h-full min-w-[280px] flex-1 flex-col overflow-hidden rounded-[1.5rem] border border-orange-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-elev md:min-w-[320px]"
                        >
              ...
              {regularPosts.length > 0
                ? paginatedPosts.map((post, i) => {
                    ...
                    return (
                      <article
                        key={post.id}
                        className="flex h-full flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-elev group-hover:border-brand"
