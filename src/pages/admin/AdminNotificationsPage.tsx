  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        {message && (
          <div
            className={`rounded-2xl border px-4 py-3 text-sm ${message.type === "success" ? "border-primary/40 bg-primary/10 text-primary" : "border-red-200 bg-red-50 text-red-800"}`}
          >
            {message.text}
          </div>
        )}
