  ...
  return (
    <>
      ...
      <div className="space-y-3">
        ...
        {message ? (
          <div
            className={`rounded-3xl border px-4 py-3 text-sm ${message.type === "success" ? "border-primary/40 bg-primary/10 text-primary" : "border-destructive/30 bg-destructive/10 text-destructive"}`}
          >
            {message.text}
          </div>
        ) : null}
