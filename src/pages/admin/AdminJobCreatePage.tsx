        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t("admin.jobs.create.description")}
            </p>
          </div>
          <Button size="lg" variant="outline" onClick={() => navigate("/admin/jobs")}>
            {t("admin.jobs.create.button.back")}
          </Button>
        </div>
      </div>
      <form onSubmit={handleSubmit} className="grid gap-6">
        <div className="rounded-3xl border border-border bg-card p-8 shadow-soft grid gap-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.city")}
              </label>
              <Select
                value={form.location_city}
                onValueChange={(value) => setForm((prev) => ({ ...prev, location_city: value }))}
              >
            ...
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.country")}
              </label>
              <Input
                name="location_country"
                value={form.location_country}
                onChange={handleChange}
                placeholder={t("admin.jobs.create.field.countryPlaceholder")}
              />
            </div>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="consultance">
                    {t("admin.jobs.field.contractTypeOption.consultance")}
                  </SelectItem>
            ...
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.status")}
              </label>
              <Select
                value={form.status}
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="draft">
                    {t("admin.jobs.create.field.statusOption.draft")}
                  </SelectItem>
                  <SelectItem value="published">
                    {t("admin.jobs.create.field.statusOption.published")}
                  </SelectItem>
                  <SelectItem value="archived">
                    {t("admin.jobs.create.field.statusOption.archived")}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.applicationEmail")}
              </label>
              <Input
                name="application_email"
                value={form.application_email}
                onChange={handleChange}
                placeholder={t("admin.jobs.create.field.applicationEmailPlaceholder")}
              />
            </div>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.externalLink")}
              </label>
              <Input
                name="external_link"
                value={form.external_link}
                onChange={handleChange}
                placeholder={t("admin.jobs.create.field.externalLinkPlaceholder")}
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
          ...
          <div>
            <label className="block text-sm font-semibold text-foreground mb-2">
              {t("admin.jobs.create.field.description")}
            </label>
            <Textarea
              name="description"
              ...
              required
              rows={6}
              placeholder={t("admin.jobs.create.field.requirementsPlaceholder")}
            />
          </div>
          <div>
            <label className="block text-sm font-semibold text-foreground mb-2">
              {t("admin.jobs.create.field.requirements")}
            </label>
            <Textarea
              name="requirements"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.companyLogo")}
              </label>
              <Input
                name="company_logo"
            ...
            <div>
              <label className="block text-sm font-semibold text-foreground mb-2">
                {t("admin.jobs.create.field.coverImage")}
              </label>
              <Input
                name="cover_image"
          ...
          >
            {saving
              ? t("admin.jobs.create.saving")
              : savedOfferId
                ? t("admin.jobs.create.validate")
