...
const featureGroups = [
  {
    ...
    value: "7",
    subtitle: "Jusqu’à 7 recommandations",
    icon: Sparkles,
  },
  {
    title: "Offres enregistrées",
    value: "7",
    subtitle: "Conservez davantage d’opportunités qui correspondent à votre projet professionnel.",
    icon: Bookmark,
  },
  {
    title: "Outils de suivi",
    value: "—",
    subtitle: "Le suivi avancé arrive avec Premium+.",
    icon: Check,
  },
];
