...
const FR: Dict = {
  ...
  "admin.sidebar.candidates": "Utilisateurs",
  "admin.candidates.title": "Gestion des utilisateurs",
  ...
  "admin.candidates.error": "Une erreur est survenue lors de la gestion des candidats.",
  ...
  "admin.dashboard.action.writeArticle": "Rédiger un article",
...
const EN: Dict = {
  ...
  "blog.article.information": "Information",
  "blog.article.category": "Category",
  "blog.article.publishedAt": "Published on",
  "blog.article.tags": "Tags",
  "blog.article.resources": "Resources",
  "blog.article.externalLink": "External link",
  "blog.article.watchVideo": "Watch video",
  ...
  "admin.dashboard.metric.featuredPosts": "Featured posts",
  "admin.dashboard.blog.title": "Blog",
  "admin.dashboard.blog.subtitle": "Featured",
  "admin.dashboard.blog.description": "Track published articles and highlight key content.",
  "admin.dashboard.blog.featuredCount": "Featured posts count",
  "admin.dashboard.admin.title": "Administration",
  "admin.dashboard.admin.subtitle": "Admin accounts",
  "admin.dashboard.admin.description": "Administrator account statistics and role breakdown.",
  "admin.dashboard.admin.active": "Active",
  "admin.dashboard.admin.blocked": "Blocked",
  "admin.dashboard.admin.roles": "Role distribution",
  "admin.dashboard.action.viewBlog": "View blog",
  "admin.dashboard.action.viewTeam": "View team",
  "admin.dashboard.action.createJob": "Create a job",
  ...
  "admin.team.status.active": "Active",
  "admin.team.status.blocked": "Blocked",
  "admin.team.viewProfile": "View profile",
  "admin.team.loading": "Loading admins…",
  "admin.team.empty": "No admins found.",
  "admin.team.accessDenied": "This view is restricted to the super administrator.",
  "admin.team.defaultName": "Administrator",
  "admin.team.defaultSpecialty": "Administration",
  "admin.team.createAdmin": "Create admin",
  "admin.team.actions.edit": "Edit",
  "admin.team.actions.block": "Block",
  "admin.team.actions.unblock": "Unblock",
  ...
  "admin.team.form.specialty": "Specialty",
  "admin.team.form.role": "Role",
  "admin.team.form.required": "Email and password are required.",
  "admin.team.form.userCreateError": "The administrator account could not be created.",
  "admin.team.form.save": "Save",
  "admin.team.form.create": "Create",
  "admin.team.form.saving": "Saving…",
  "admin.team.role.admin": "Administrator",
  "admin.team.role.editor": "Editor",
  "admin.team.role.superAdmin": "Super administrator",
  "admin.team.toast.created": "Administrator created successfully.",
  "admin.team.toast.updated": "Administrator updated.",
  "admin.team.toast.blocked": "Administrator blocked.",
  "admin.team.toast.unblocked": "Administrator unblocked.",
  "admin.team.toast.deleted": "Administrator deleted.",
  "admin.team.toast.selfAction": "You cannot perform this action on your own account.",
  "admin.team.toast.error": "An error occurred.",
  ...
  "admin.sidebar.candidates": "Users",
  "admin.candidates.title": "Candidate management",
  "admin.candidates.description": "Manage registered candidate profiles and statuses.",
  "admin.candidates.actions.view": "View details",
  "admin.candidates.actions.block": "Block",
  "admin.candidates.actions.unblock": "Unblock",
  "admin.candidates.actions.delete": "Delete",
  "admin.candidates.status.active": "Active",
  "admin.candidates.status.inactive": "Inactive",
  "admin.candidates.status.archived": "Archived",
  "admin.candidates.counts.active": "Active",
  ...
  "admin.candidates.table.joined": "Joined",
  "admin.candidates.table.actions": "Actions",
  "admin.candidates.updateSuccess": "Candidate status updated.",
  "admin.candidates.deleteSuccess": "Candidate deleted.",
  "admin.candidates.error": "An error occurred while managing candidates.",
  "admin.candidates.confirmDelete": "Delete this candidate permanently?",
...
const LN: Dict = {
  ...
  "blog.readMore": "Kosoma lisusu",
  "blog.article.content": "Eloko ya mokanda",
  "blog.article.information": "Mayele",
  "blog.article.category": "Ekipu",
  "blog.article.publishedAt": "Ekopamá na",
  "blog.article.tags": "Mots clés",
  "blog.article.resources": "Biloko",
  "blog.article.externalLink": "Lien externe",
  "blog.article.watchVideo": "Tala vidéo",
  "blog.backToList": "Moya na ba articles",
...
const ES: Dict = {
  ...
  "blog.article.content": "Contenido del artículo",
  "blog.article.information": "Información",
  "blog.article.category": "Categoría",
  "blog.article.publishedAt": "Publicado el",
  "blog.article.tags": "Etiquetas",
  "blog.article.resources": "Recursos",
  "blog.article.externalLink": "Enlace externo",
  "blog.article.watchVideo": "Ver video",
  "blog.backToList": "Volver a los artículos",
...
const SW: Dict = {
  ...
  "blog.article.content": "Yaliyomo ya makala",
  "blog.article.information": "Taarifa",
  "blog.article.category": "Kitengo",
  "blog.article.publishedAt": "Ilichapishwa",
  "blog.article.tags": "Lebo",
  "blog.article.resources": "Rasilimali",
  "blog.article.externalLink": "Kiungo cha nje",
  "blog.article.watchVideo": "Tazama video",
  "blog.backToList": "Rudi kwenye machapisho",
...
const PT: Dict = {
  ...
  "blog.article.content": "Conteúdo do artigo",
  "blog.article.information": "Informações",
  "blog.article.category": "Categoria",
  "blog.article.publishedAt": "Publicado em",
  "blog.article.tags": "Etiquetas",
  "blog.article.resources": "Recursos",
  "blog.article.externalLink": "Link externo",
  "blog.article.watchVideo": "Assistir vídeo",
  "blog.backToList": "Voltar aos posts",
