...
const FR: Dict = {
  ...
  "services.card1.detail": "Publication et diffusion d'offres, recherche et sélection de candidats, recrutement, bases de données de talents, accompagnement des candidats et préparation aux entretiens.",
  "services.card2.detail": "Mise à disposition de personnel, gestion administrative, paie, contrats, suivi des employés, externalisation de la gestion RH.",
  "services.card3.detail": "Conseil en organisation, digitalisation des processus, ingénierie informatique, ERP, solutions de gestion et formation professionnelle.",
  "services.card4.detail": "Prestations sur site client, support administratif, assistance opérationnelle, appui technique et missions ponctuelles ou permanentes.",
