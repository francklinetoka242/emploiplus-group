...
export const FR: Dict = {
  ...
  "maelise.subtitle": "Assistante EmploiPlus",
  "maelise.open": "Ouvrir Maélise",
  "maelise.close": "Fermer Maélise",
  "maelise.conversationLabel": "Conversation avec Maélise",
  "maelise.sendFormLabel": "Envoyer un message à Maélise",
  "maelise.messageLabel": "Votre message",
  "maelise.placeholder": "Écrivez votre question…",
  "maelise.send": "Envoyer le message",
  "maelise.thinking": "Maélise prépare une réponse…",
  "maelise.suggestion.jobs": "Trouver une offre d'emploi",
  ...
  "admin.analytics-offres.title": "Analytics-Offres",
  "admin.analytics-offres.description": "Analyse complète des offres d'emploi et des candidatures",
  "admin.analytics-offres.kpi.totalApplications": "Candidatures totales",
  "admin.analytics-offres.kpi.uniqueCandidates": "Candidats uniques",
  "admin.analytics-offres.kpi.publishedOffers": "Offres publiées",
  "admin.analytics-offres.filters.title": "Filtres",
  "admin.analytics-offres.filters.from": "Du",
  "admin.analytics-offres.filters.to": "Au",
  "admin.analytics-offres.filters.company": "Entreprise",
  "admin.analytics-offres.filters.contractType": "Type de contrat",
  "admin.analytics-offres.filters.city": "Ville",
  "admin.analytics-offres.filters.applicationStatus": "Statut candidature",
  "admin.analytics-offres.filters.reset": "Réinitialiser",
  "admin.analytics-offres.export.title": "Exporter les données",
  "admin.analytics-offres.export.csv": "Exporter en CSV",
  "admin.analytics-offres.export.json": "Exporter en JSON",
  "admin.analytics-offres.trends.title": "Tendance des candidatures",
  "admin.analytics-offres.companies.title": "Top Entreprises",
  "admin.analytics-offres.contracts.title": "Distribution par Type de Contrat",
  "admin.analytics-offres.status.title": "Statut des Candidatures",
  "admin.analytics-offres.locations.title": "Top Localisations",
  "admin.analytics-offres.offers.title": "Détails des Offres",
...
export const EN: Dict = {
  ...
  "maelise.welcome":
    "Hello, I am Maélise, EmploiPlus Group's virtual assistant. I can help with jobs, applications, your CV, or questions about EmploiPlus.",
  "maelise.subtitle": "EmploiPlus assistant",
  "maelise.open": "Open Maélise",
  "maelise.close": "Close Maélise",
  "maelise.conversationLabel": "Conversation with Maélise",
  "maelise.sendFormLabel": "Send a message to Maélise",
  "maelise.messageLabel": "Your message",
  "maelise.placeholder": "Write your question…",
  "maelise.send": "Send message",
  "maelise.thinking": "Maélise is preparing an answer…",
  "maelise.suggestion.jobs": "Find a job",
  "maelise.suggestion.cv": "How can I improve my CV?",
  "maelise.suggestion.application": "How does an application work?",
  "maelise.suggestion.services": "What does EmploiPlus offer?",
};
...
export const LN: Dict = {
  ...
  "maelise.welcome":
    "Mbote, nazali Maélise, mosungi ya mayele ya EmploiPlus Group. Nakoki kosalisa yo na misala, ba candidatures, CV na yo to mituna na ntina ya EmploiPlus.",
  "maelise.subtitle": "Mosungi EmploiPlus",
  "maelise.open": "Fungola Maélise",
  "maelise.close": "Kanga Maélise",
  "maelise.conversationLabel": "Lisolo na Maélise",
  "maelise.sendFormLabel": "Tinda nsango na Maélise",
  "maelise.messageLabel": "Nsango na yo",
  "maelise.placeholder": "Koma motuna na yo…",
  "maelise.send": "Tinda nsango",
  "maelise.thinking": "Maélise azali kobongisa eyano…",
  "maelise.suggestion.jobs": "Luka mosala",
  "maelise.suggestion.cv": "Ndenge nini nakoki kobongisa CV na ngai?",
  "maelise.suggestion.application": "Ndenge nini candidature esalaka?",
  "maelise.suggestion.services": "EmploiPlus epesaka nini?",
};
