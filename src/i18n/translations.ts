...
export const FR: Dict = {
  ...
  "admin.jobs.create.field.requirements": "Exigences du poste",
  "admin.jobs.create.field.requirementsPlaceholder": "Listez les compétences et qualifications attendues",
