...
function normalizeErrorMessage(value) {
    ...
    if (typeof value === 'object' && value !== null) {
        ...
        if (typeof objectValue.msg === 'string')
        ...
        const errorObj = objectValue.error;
        if (errorObj && typeof errorObj['msg'] === 'string')
            return errorObj['msg'];
...
export default async function handler(req, res) {
    ...
    const EMAIL_SIGNING_SECRET = process.env.EMAIL_SIGNING_SECRET;
    ...
    try {
        ...
        console.log('createUserResp', createUserResp.status);
        const createUserBody = await readResponseBody(createUserResp);
        console.log('createUserBody', createUserBody);
